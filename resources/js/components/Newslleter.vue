<template>
    <div class="w-[90%] h-[376px] flex justify-center items-end flex-col m-auto">
        ...
        <form action="" method="POST" class="flex flex-col items-end gap-3 w-full max-w-[340px] mt-[1rem] sm:max-w-[414px] md:max-w-[530px]">
