<template>
    <div id="mySidenav" class="fixed top-0 left-0 h-full w-0 opacity-0 z-0 bg-white overflow-x-hidden transition-all duration-500 pl-14 pt-7 pr-2" :class="{'w-[480px] opacity-100': sidenavOpen}">
