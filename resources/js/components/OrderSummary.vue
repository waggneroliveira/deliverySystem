    ...
    <div class="order-summary bg-[#031D40] text-white p-4 w-full relative">
        ...
        <div class="w-[90%] m-auto pt-[20px] sm:pt-[41px] pb-0 sm:pb-[25px]">
            ...
            <div class="flex justify-between mb-3 pb-3 border-b border-[#DAAB22]">
                ...
                <span class="noto-sans-devanagari-semibold text-[#FFF] text-[0.875rem] sm:text-[1.125rem]">€ 177,00</span>
            </div>
            ...
            <div class="flex justify-between mb-3 pb-3 border-b border-[#DAAB22]">
                ...
                <span class="noto-sans-devanagari-semibold text-[#FFF] text-[0.875rem] sm:text-[1.125rem]">€ 15,00</span>
            </div>
            ...
            <div class="flex justify-between pb-3 border-b border-[#DAAB22]">
                ...
                <span class="noto-sans-devanagari-semibold text-[#FFF] text-[0.875rem] sm:text-[1.125rem]">€ 72,00</span>
            </div>
            ...
            <div class="flex justify-between mt-5 mb-4 pt-2 border-b border-[#DAAB22]">
                ...
                <span class="noto-sans-devanagari-semibold text-[#FFF] text-[1.125rem] sm:text-[1.375rem]">€ 87,00</span>
            </div>
