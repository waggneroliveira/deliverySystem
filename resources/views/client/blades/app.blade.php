...
@section('content')
    ...
    <section id="products" class="relative flex justify-center items-center">
        <img loading="lazy" src="{{asset('build/client/images/firula-products.png')}}" alt="Firula" class="!w-[20px] sm:w-[45px] absolute right-0 top-0">
    ...
    <section id="newslleter" class="newlleter w-full relative z-10 h-[230px] sm:h-[376px]">
